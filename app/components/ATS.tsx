    ...
    <div className={`bg-gradient-to-b ${gradientClass} w-full rounded-2xl to-white p-6 shadow-md`}>
      ...
      <div className="mb-6">
        ...
        <p className="mb-4 text-gray-600">
          This score represents how well your resume is likely to perform in Applicant Tracking
      ...
      <p className="text-gray-700 italic">
        Keep refining your resume to improve your chances of getting past ATS filters and into the
        hands of recruiters.
      </p>
    </div>
  )
